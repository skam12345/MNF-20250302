...
public class StageObjectClass
{
	...
	// 데이터 초기화를 위해 Get Set이 아닌 변수 형태로 초기화
	public void Init(StageObjectClass _data)
	{
		stageNum = _data.stageNum;
		subNum = _data.subNum;
		dungeonName = _data.dungeonName;
		rewardExp = _data.rewardExp;
		rewardGold = _data.rewardGold;
		difficulty = _data.difficulty;
		monster1 = _data.monster1;
		monster2 = _data.monster2;
		monster3 = _data.monster3;
		monster4 = _data.monster4;
